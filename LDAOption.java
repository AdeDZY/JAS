...
public class LDAOption implements Serializable {
	...
	public int S = 3; //number of sentiments

	public double alpha = 0.5;  //Specify alpha  ////
	public double beta[][] = {{0.001, 0.00001, 0.0001},{0.00001, 0.001, 0.0001},{0.0001, 0.0001, 0.001}};  //Specify beta
	public double gama[] = {1, 1, 3}; // Specify gama
